...
curl -4skL "https://raw.githubusercontent.com/excelsiorcode/x-monitor/master/GeoLite2-City.mmdb.7z" -o /var/lib/GeoIP/GeoLite2-City.mmdb.7z 2> /dev/null
cd /var/lib/GeoIP
...
_config(){
echo -e "Configuring openvpn-monitor..."
cd /var/www/html
